 ...
 elseif self.state==state_load_level or self.state==state_play then
  if not self.is_metalevel then
   ...
   if player!=nil and player.node.level!=nil and not is_blink then
    print("level "..tostr(player.node.level),52,80)
   end
  end
  draw_board()
 end
...
function draw_card()
 ...
 -- level.turns=23
 -- level.max_enemies_killed=level.enemies
 -- level.has_briefcase=true
 -- level.has_taken_briefcase=true
 -- level.has_achieved_no_kill=true
...
__gff__

